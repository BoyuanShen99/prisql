...
from communication.VOLE.VOLESender import VOLESender
...
async def main(local_port, remote_ip, remote_port):
    ...
    vole_sender = VOLESender(data_handler, N=16, n=20, t=2, prime=prime, r=r, lam=lam)

    await vole_sender.gen()

    u, v = vole_sender.expand()
